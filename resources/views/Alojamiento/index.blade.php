...
@endcan
                                                    ...
                                                    @can('editar-alojamiento')
                                                        <a href="{{ route('alojamiento.edit', $alojamiento->idAlojamiento) }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <input class="form-check-input toggle-activation" type="checkbox"
                                                            role="switch" data-id="{{ $alojamiento->idAlojamiento }}"
                                                            id="switch-{{ $alojamiento->idAlojamiento }}"
                                                            {{ $alojamiento->activo ? 'checked' : '' }} />
                                                        <label class="form-check-label"
                                                            for="switch-{{ $alojamiento->idAlojamiento }}">
    ...
    <style>
        .custom-switch-size .form-check-input {
            ...
            height: 20px;
            transform: scale(1.2);
            /* Cambia el valor si deseas hacerlo aún más grande */
        }
