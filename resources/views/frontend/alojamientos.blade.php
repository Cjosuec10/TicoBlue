                        ...
                        <div class="col-12 d-flex justify-content-end">
                            <div class="input-group" style="width: 100%; max-width: 300px;">
                                ...
                                <input type="text" id="search" class="form-control"
                                    placeholder="Buscar alojamientos..." aria-label="Buscar alojamientos">
                                <span class="input-group-text bg-white">
                    ...
                    <div class="row">
                        ...
                        @else
                            ...
                            <div class="col-lg-3 col-md-4 mb-4">
                                        ...
                                        <div class="modal-content border-0 shadow-lg rounded-4">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="alojamiento-details">
                                                    <p><strong>Descripción:</strong> {{ $aloja->descripcionAlojamiento }}
                                                    </p>
                                                    ...
                                                    <p><strong>Comercio:</strong>
                                                        {{ $aloja->comercio->nombreComercio ?? 'No especificado' }}</p>
                                ...
                                <!-- Modal for Alojamiento Reservation Form -->
                                        ...
                                        <div class="modal-content border-0 shadow-lg rounded-4">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('reservaciones.store') }}" method="POST"
                                                    enctype="multipart/form-data" class="crearAlojamientoForm">
                                                    @csrf
                                                    <!-- Alojamiento ID -->
                                                    ...
                                                    @if (Auth::check())
                                                        ...
                                                        <!-- Display Comercio Name (Read-only) -->
                                                        <div class="form-group mb-3">
                                                    ...
                                                    @else
                                                        ...
                                                        <p class="text-center text-danger">Por favor, inicia sesión para
                                                            hacer una reservación.</p>
                                                    @endif
                                                </form>
                                            </div>
                                        </div>
