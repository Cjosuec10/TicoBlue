                            ...
                            @foreach ($productos as $producto)
                                <div class="col-lg-3 col-md-4 mb-4">
                                    <div class="card shadow-sm rounded-4 border-0" style="width: 15rem;">
                                        <img src="{{ asset($producto->imagenProducto) }}"
                                            alt="{{ $producto->nombreProducto }}" class="card-img-top"
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between">
                                            ...
                                            <div class="d-flex justify-content-center mt-3">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#productoModal{{ $producto->idProducto }}">
                                                    Ver más
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <!-- Modal -->
                                <div class="modal fade" id="productoModal{{ $producto->idProducto }}" tabindex="-1"
                                    aria-labelledby="productoModalLabel{{ $producto->idProducto }}" aria-hidden="true">
                                        ...
                                        <div class="modal-content border-0 shadow-lg rounded-4">
                                            <div class="modal-header bg-light text-dark justify-content-center">
                                                <h5 class="modal-title text-center fw-bold"
                                                    id="productoModalLabel{{ $producto->idProducto }}"
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="product-details">
                                                    <p><strong>Descripción:</strong> {{ $producto->descripcionProducto }}
                                                    </p>
                                                    <p class="text-success"><strong>Precio:</strong>
                                                        ${{ $producto->precioProducto }}</p>
                                                    <p><strong>Categoría:</strong> {{ $producto->categoria }}</p>
                                                    <p><strong>Vendido por:</strong> <span
                                                            class="text-primary">{{ $producto->comercio->nombreComercio }}</span>
                                                    </p>
                                                </div>
                                            </div>
